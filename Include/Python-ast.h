...
enum _expr_kind {BoolOp_kind=1, BinOp_kind=2, UnaryOp_kind=3, Lambda_kind=4,
                  ...
                  NamedExp_kind=12, Await_kind=13, Yield_kind=14,
...
expr_ty _Py_GeneratorExp(expr_ty elt, asdl_seq * generators, int lineno, int
                         col_offset, PyArena *arena);
#define NamedExp(a0, a1, a2, a3, a4) _Py_NamedExp(a0, a1, a2, a3, a4)
expr_ty _Py_NamedExp(expr_ty body, identifier asname, int lineno, int
                     col_offset, PyArena *arena);
